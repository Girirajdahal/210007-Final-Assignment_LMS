...
#keeping title
label=Label(frame,text="ADD A BOOK",bg="#383956",fg="white",font=("Times New Roman",40))
...
id=Label(frame,text="Book Id",bg="#383956",fg="white",font=("Times New Roman",30))
id.grid(row=2,column=0,sticky="nw",padx=1)

e2= Entry(frame, width=50)
e2.grid(row=2,column=1,padx=20,pady=10,ipady=5)

author=Label(frame,text="Author",bg="#383956",fg="white",font=("Times New Roman",30))
author.grid(row=3,column=0,sticky="nw",padx=1)

e3= Entry(frame, width=50)
e3.grid(row=3,column=1,padx=20,pady=10,ipady=5)

submit=Button(frame,text="Submit",padx=10,pady=10,highlightbackground="#bfd8d5",font=("Times New Roman",30))
