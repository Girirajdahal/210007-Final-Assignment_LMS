...
#keeping title
label=Label(frame,text="ISSUE A BOOK",bg="#383956",fg="white",font=("Times New Roman",40))
...
issuedate=Label(frame,text="Issue Date",bg="#383956",fg="white",font=("Times New Roman",30))
issuedate.grid(row=4,column=0,sticky="nw",padx=1)

e3= Entry(frame, width=50)
e3.grid(row=4,column=1,padx=20,pady=10,ipady=5)

submit=Button(frame,text="Issue",highlightbackground="#bfd8d5",font=("Times New Roman",30))
